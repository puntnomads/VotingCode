...
class Poll extends React.Component {
  ...
  submit = values => {
    ...
    const selectedOption = values.selectedOption ? values.selectedOption : undefined;
  ...
  render() {
    const {
      ...
      selectedOption,
      handleSubmit,
      poll: { requesting, successful, messages, errors, poll }
    } = this.props;
    ...
    return (
      ...
      <div className="page">
        ...
        <div className="auth-messages">
          {!requesting &&
            !!errors.length &&
            <Errors message="Failure to update poll due to:" errors={errors} />}
          {!requesting &&
            !!messages.length &&
